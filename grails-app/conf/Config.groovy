...
environments {
    development {
		...
		adminEmail="mutualproject908@gmail.com"
    }
    production {
...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.liason.auth.UserRole'
grails.plugin.springsecurity.authority.className = 'com.liason.auth.Role'
